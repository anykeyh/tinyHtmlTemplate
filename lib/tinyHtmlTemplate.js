...
(typeof module !== "undefined" && module !== null ? module.exports = {} : window)[_STR_THT] = (function() {

  /*
    List of standard tags.
   */
  var HTML, HTML_DSL, TAGS, _STR_FUNCTION, _STR_STRING, _is, consoleError, consoleGroup, consoleGroupEnd, createSubTemplate, createTagFunction, dc, i, len, popdc, pushdc, setFields, showdc, tag;
  ...
  HTML_DSL = (function() {
    ...
    HTML_DSL.prototype.appendTo = function(elm) {
  ...
  HTML = {
    ...
    render: function(elm, cb) {
      ...
      try {
        pushdc("#render");
        if ((cb == null) && _is(elm, _STR_FUNCTION)) {
          cb = elm;
          elm = null;
        }
        if (elm) {
